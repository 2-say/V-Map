...
public class NotionPatchServiceImpl {
    ...
    public void patchToNotion(String documentId, String requestBody) throws Exception {
        ...
        appendToFile(time,user,contents,documentId);
    }



    public void appendToFile(String time, String user, String contents, String documentId) throws IOException {
        String filePath = "/home/lab329/VMap/data/"+ documentId + ".txt"; // 파일 경로, 사용자 ID를 파일명에 포함
